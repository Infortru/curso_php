        ...
        <form action="../Controlador/transacciones.php" method="post" enctype="multipart/form-data" name="form1">
            <table >
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="area_comentarios" id="area_comentarios" rows="10" cols="50"></textarea></td>
                </tr>
                    <input type="hidden" name="MAX_TAM" value="2097152"> <!--Tamaño máximo permitido-->
                <tr>
                    <td colspan="2" text-align="center">
                        Seleccione una imagen con tamaño inferior a 2 MB
                    </td>
                </tr>
                <tr>
